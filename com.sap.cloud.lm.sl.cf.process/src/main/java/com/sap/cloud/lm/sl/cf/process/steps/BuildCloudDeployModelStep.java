...
public class BuildCloudDeployModelStep extends SyncFlowableStep {
    ...
    protected StepPhase executeStep(ExecutionWrapper execution) {
        try {
            ...
            StepsUtil.setModuleToDeployClass(execution.getContext(), modulesCalculatedForDeployment);

            ApplicationsCloudModelBuilder applicationsCloudModelBuilder = getApplicationsCloudModelBuilder(execution.getContext());
            // List<CloudApplicationExtended> apps = applicationsCloudModelBuilder.build(modulesCalculatedForDeployment,
            ...
            List<String> customDomainsFromApps = StepsUtil.getDomainsFromApps(execution.getContext(), modulesCalculatedForDeployment,
                moduleToDeployHelper);
    ...
    // }
    //
    // private Set<String> getUnresolvedModules(List<ModuleToDeploy> modulesToDeploy, Set<String> deployedModules, Set<String>
    // allMtaModules) {
