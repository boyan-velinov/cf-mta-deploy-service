...
public class MicrometerProcessesMetricsRecorderImplTest {
    ...
    private MicrometerProcessesMetricsRecorder micrometerProcessesMetricsRecorder;
    ...
    public MicrometerProcessesMetricsRecorderImplTest() {
        MockitoAnnotations.initMocks(this);
    }

    @BeforeEach
    public void setUp() {
        micrometerProcessesMetricsRecorder = new MicrometerProcessesMetricsRecorderImpl();
        setupStandardTags();
        Mockito.when(jmxMeterRegistry.counter(Mockito.anyString(), Mockito.anyIterable()))
               .thenReturn(counter);
        Mockito.when(jmxMeterRegistry.timer(Mockito.anyString(), Mockito.anyIterable()))
               .thenReturn(timer);
    }

    @Test
    public void testRecordStartProcessEvent() {
        micrometerProcessesMetricsRecorder.recordStartProcessEvent(execution);

        ArgumentCaptor<HashSet<Tag>> argumentCaptor = ArgumentCaptor.forClass(HashSet.class);
        Mockito.verify(jmxMeterRegistry)
    ...
    public void testRecordEndProcessEvent() {
        micrometerProcessesMetricsRecorder.recordEndProcessEvent(execution);
    ...
    public void testRecordErrorProcessEvent() {
        ...
        micrometerProcessesMetricsRecorder.recordErrorProcessEvent(execution, errorMessage);
    ...
    public void testRecordErrorProcessEventWithLongErrorMessage() {
        micrometerProcessesMetricsRecorder.recordErrorProcessEvent(execution, LONG_ERROR_MESSAGE);
    ...
    public void testRecordOverallTime() {
        ...
        long duration = 1;
        micrometerProcessesMetricsRecorder.recordOverallTime(execution, state, duration);
